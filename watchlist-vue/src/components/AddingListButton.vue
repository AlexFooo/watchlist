          ...
          <div class="flex min-h-full md:items-center justify-center md:p-4 text-center">
            ...
            >
              ...
              >
                ...
                <div class="bg-blue-50 flex gap-2">
                  <input
                    type="text"
                    v-model="searchQuery"
                ...
                <div v-else class="watchlist-list overflow-auto h-full max-h-[calc(100vh-14rem)]">
                  <WatchListStock
                    :stock="stock"
                    v-for="stock in searchList"
                    :key="stock.symbol"
                    @click="toggleUserStock(stock)"
                  >
                    <template #right>
                      <div class="watchlist-item-right flex flex-wrap justify-end">
                        <button class="p-3 text-2xl hover:bg-slate-100">
