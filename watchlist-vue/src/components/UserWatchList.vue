<template>
  <div class="mx-auto">
    <div class="wathhlist-top-bar bg-slate-100 mt-1">
      <Transition
        mode="out-in"
      ...
      >
        <div v-if="isSorting" class="bg-blue-50 flex gap-2">
                  ...
                  >
                    ...
                    <div v-else class="watchlist-item-right md:w-full">
                      ...
                      >
                        ...
                        <div>
                          <a
                            class="px-5 py-2 md:flex hidden text-white bg-[#12A600] font-sans text-xs font-bold rounded"
                          >
                            TRADE</a
                          >
                        </div>
