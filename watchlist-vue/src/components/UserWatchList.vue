      ...
      >
        <div v-if="isAdding" class="bg-blue-50 flex gap-2">
          ...
          <input
            type="text"
            v-model="searchQuery"
            class="w-full bg-transparent px-4 py-2"
            placeholder="Search"
          />
        </div>
        <div v-else-if="isEditing" class="flex gap-2 justify-between">
          ...
          <button
            @click="applyEditingChanges"
            class="p-2 hover:bg-slate-300 text-4xl aspect-square"
          >
            <svg
              width="24"
              height="24"
            ...
            <template #header>
              ...
              <div v-if="userStocks.length === 0">
                ...
                <button
                  @click="toggleAddMenu"
                  v-if="!isEditing"
                  class="px-4 py-3 bg-blue-800 text-white w-full"
                >
