<template>
  <div
    class="watchlist-item flex justify-between items-center w-full px-4 py-3 border-b-2 overflow-hidden"
  >
    <div class="watchlist-item-left flex gap-2 items-center">
      <slot name="left" />
