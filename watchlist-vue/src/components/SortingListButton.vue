  ...
  <div>
    <div class="">
      <Menu as="div" class="relative inline-block text-left">
        ...
        >
          <MenuItems
            class="absolute left-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-40"
          >
            <div class="px-1 py-1">
              <MenuItem v-slot="{ active }" v-for="sortOrder in sortOrders" :key="sortOrder.field">
                <button
                  class="text-base font-bold px-4 py-2 block hover:bg-blue-100 w-full text-left"
                  :class="{
